            ...
            <div class="d-flex my-xl-auto right-content align-items-center">
                <div class="pe-1 mb-xl-0">
                    <button type="button" class="btn btn-primary btn-compose me-2 btn-b"
                        onclick="openFolderModal('')"><i class="fa fa-plus mx-2"></i>
                        Create Folder</button>
                </div>
                <div class="mb-xl-0">
                    <a href="{{ route('upload.root.form') }}" class="btn btn-success btn-compose me-2 btn-b"><i
                            class="fa fa-upload mx-2"></i>
                        Upload</a>
                </div>
            </div>
        </div>
